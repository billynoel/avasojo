...
--
-- Host: localhost:3306
-- Generation Time: May 09, 2016 at 05:03 PM
...
--
-- Table structure for table `y0hw2_assets`
--

CREATE TABLE IF NOT EXISTS `y0hw2_assets` (
...
--
-- Dumping data for table `y0hw2_assets`
--

INSERT INTO `y0hw2_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(18, 1, 43, 98, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(54, 27, 19, 20, 3, 'com_content.article.1', 'demo', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(55, 18, 74, 75, 2, 'com_modules.module.87', 'head left', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(56, 18, 76, 77, 2, 'com_modules.module.88', 'head right', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(57, 18, 78, 79, 2, 'com_modules.module.89', 'logo', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(58, 18, 80, 81, 2, 'com_modules.module.90', 'header right', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(59, 27, 21, 22, 3, 'com_content.article.2', 'Articles', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(60, 18, 82, 83, 2, 'com_modules.module.91', 'content-1', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(61, 18, 84, 85, 2, 'com_modules.module.92', 'content-2', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(62, 18, 86, 87, 2, 'com_modules.module.93', 'content-3', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(63, 18, 88, 89, 2, 'com_modules.module.94', 'footer-menu', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(64, 18, 90, 91, 2, 'com_modules.module.95', 'footer-1', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(65, 18, 92, 93, 2, 'com_modules.module.96', 'footer-3', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(66, 18, 94, 95, 2, 'com_modules.module.97', 'footer-4', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}'),
(67, 18, 96, 97, 2, 'com_modules.module.98', 'copyright', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"module.edit.frontend":[]}');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_associations`
--

CREATE TABLE IF NOT EXISTS `y0hw2_associations` (
...
--
-- Table structure for table `y0hw2_banners`
--

CREATE TABLE IF NOT EXISTS `y0hw2_banners` (
...
--
-- Table structure for table `y0hw2_banner_clients`
--

CREATE TABLE IF NOT EXISTS `y0hw2_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `y0hw2_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `y0hw2_banner_tracks` (
...
--
-- Table structure for table `y0hw2_categories`
--

CREATE TABLE IF NOT EXISTS `y0hw2_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `y0hw2_categories`
--

INSERT INTO `y0hw2_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 234, '2016-05-09 12:18:07', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
...
--
-- Table structure for table `y0hw2_contact_details`
--

CREATE TABLE IF NOT EXISTS `y0hw2_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `y0hw2_content`
--

CREATE TABLE IF NOT EXISTS `y0hw2_content` (
...
--
-- Dumping data for table `y0hw2_content`
--

INSERT INTO `y0hw2_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 54, 'demo', 'demo', '<h1>Lorem Ipsum</h1>\r\n<h4>"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit..."</h4>\r\n<h5>"There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain..."</h5>\r\n<hr />\r\n<div id="lipsum">\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer in posuere tellus, ut luctus massa. Aliquam facilisis rhoncus ante, quis euismod dolor molestie eu. Morbi tempor lacus non erat pulvinar congue. Proin consectetur ipsum aliquam odio facilisis, vel porttitor sem volutpat. Nam blandit, augue id luctus finibus, purus nisl pellentesque massa, ut euismod augue lorem vitae ligula. Fusce tempor felis felis, sed sollicitudin ipsum venenatis in. Morbi scelerisque lobortis rutrum. Sed interdum fringilla sollicitudin. Cras ac neque at libero porta condimentum nec sit amet dolor. Morbi a porta nisl. Vestibulum quis dolor fringilla, auctor nibh vitae, euismod elit. Nulla molestie semper ipsum, nec mollis lacus tincidunt ut. Quisque nec turpis vel nibh porta egestas. Nulla facilisi.</p>\r\n<p>Donec eget volutpat leo, eu maximus sapien. Praesent molestie quis mi vitae volutpat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. 
'{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 59, 'Articles', 'articles', '<div class="col-md-9 col-sm-9">\r\n<h3>Valuation Guide for Goodwill Donors</h3>\r\n<div class="row">\r\n<div class="col-md-4 col-sm-4"><img class="img-responsive" src="images/pic.png" alt="" /></div>\r\n<div class="col-md-8 col-sm-8">\r\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill ® stores. Assume the following items are in good condition, and remember: prices are only estimated values.</p>\r\n<p>Young was hauling the container not just here, but everywhere – around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water’s mission.</p>\r\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity – from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, “We think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world’s most pressing causes. We want people to love our brand. But we don’t have a traditional marketing budget – we don’t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.”</p>\r\n</div>\r\n<div class="col-md-12 fullwidth">\r\n<div class="table-responsive">\r\n<table class="table">\r\n<tbody>\r\n<tr style="color: #fff;" bgcolor="#0054A3">\r\n<th> </th>\r\n<th>Women’s</th>\r\n<th>Men’s</th>\r\n<th>Children’s</th>\r\n</tr>\r\n<tr style="color: #fff;" bgcolor="#ADC5E7">\r\n<td colspan="4">Tops</td>\r\n</tr>\r\n<tr>\r\n<td>Shirts/blouses</td>\r\n<td>$2–12</td>\r\n<td>$2–8</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n</div>\r\n<div class="table-responsive">\r\n<table class="table">\r\n<tbody>\r\n<tr style="color: #fff;" bgcolor="#0054A3">\r\n<th> </th>\r\n<th>Women’s</th>\r\n<th>Men’s</th>\r\n<th>Children’s</th>\r\n</tr>\r\n<tr style="color: #fff;" bgcolor="#ADC5E7">\r\n<td colspan="4">Tops</td>\r\n</tr>\r\n<tr>\r\n<td>Shirts/blouses</td>\r\n<td>$2–12</td>\r\n<td>$2–8</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n<tr>\r\n<td>Sweaters</td>\r\n<td>$5–15</td>\r\n<td>$5–15</td>\r\n<td>$1–6</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n</div>\r\n</div>\r\n</div>\r\n</div>', '', 1, 2, '2016-05-07 12:11:31', 234, '', '2016-05-07 12:44:34', 234, 234, '2016-05-07 12:44:34', '2016-05-07 12:11:31', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"0","link_titles":"0","show_tags":"0","show_intro":"0","info_block_position":"1","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_vote":"0","show_hits":"0","show_noauth":"0","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 6, 0, '', '', 1, 73, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `y0hw2_contentitem_tag_map` (
...
--
-- Table structure for table `y0hw2_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `y0hw2_content_frontpage` (
...
--
-- Table structure for table `y0hw2_content_rating`
--

CREATE TABLE IF NOT EXISTS `y0hw2_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `y0hw2_content_types`
--

CREATE TABLE IF NOT EXISTS `y0hw2_content_types` (
...
--
-- Dumping data for table `y0hw2_content_types`
--

INSERT INTO `y0hw2_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `y0hw2_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `y0hw2_core_log_searches` (
...
--
-- Table structure for table `y0hw2_extensions`
--

CREATE TABLE IF NOT EXISTS `y0hw2_extensions` (
...
--
-- Dumping data for table `y0hw2_extensions`
--

INSERT INTO `y0hw2_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"a90f9ed5ccaa52f72a1db66d65430fcf"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1462804491}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":2,"lastrun":1462796121,"unique_id":"b749d4463106bfbcf3609c60493d61f7484f94ab","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `y0hw2_finder_filters`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_filters` (
...
--
-- Table structure for table `y0hw2_finder_links`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links` (
...
--
-- Table structure for table `y0hw2_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms0` (
...
--
-- Table structure for table `y0hw2_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `y0hw2_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `y0hw2_finder_taxonomy`
--

INSERT INTO `y0hw2_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `y0hw2_finder_terms`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_terms` (
...
--
-- Table structure for table `y0hw2_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `y0hw2_finder_terms_common`
--

INSERT INTO `y0hw2_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `y0hw2_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `y0hw2_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `y0hw2_finder_types`
--

CREATE TABLE IF NOT EXISTS `y0hw2_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `y0hw2_languages`
--

CREATE TABLE IF NOT EXISTS `y0hw2_languages` (
...
--
-- Dumping data for table `y0hw2_languages`
--

INSERT INTO `y0hw2_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_menu`
--

CREATE TABLE IF NOT EXISTS `y0hw2_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `y0hw2_menu`
--

INSERT INTO `y0hw2_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(101, 'mainmenu', 'Articles', 'home', '', 'home', 'index.php?option=com_content&view=article&id=2', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 7, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"1","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 41, 42, 1, '*', 0),
(102, 'mainmenu', 'Resources', 'resources', '', 'resources', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"0","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 43, 44, 0, '*', 0),
(103, 'mainmenu', 'Research', 'research', '', 'research', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 46, 0, '*', 0),
(104, 'mainmenu', 'Topics', 'topics', '', 'topics', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"1","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 0, '*', 0),
(105, 'mainmenu', 'Events', 'events', '', 'events', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 49, 50, 0, '*', 0),
(106, 'mainmenu', 'Training', 'training', '', 'training', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 0, '*', 0),
(107, 'mainmenu', 'Consulting', 'consulting', '', 'consulting', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 53, 54, 0, '*', 0),
(108, 'mainmenu', 'Magazine', 'magazine', '', 'magazine', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 55, 56, 0, '*', 0),
(109, 'mainmenu', 'Podcast', 'podcast', '', 'podcast', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 57, 58, 0, '*', 0),
(110, 'mainmenu', 'Directory', 'directory', '', 'directory', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 59, 60, 0, '*', 0),
(111, 'mainmenu', 'Careers', 'careers', '', 'careers', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_title":"0","link_titles":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_hits":"0","show_tags":"0","show_noauth":"0","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 61, 62, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_menu_types`
--

CREATE TABLE IF NOT EXISTS `y0hw2_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `y0hw2_menu_types`
--

INSERT INTO `y0hw2_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_messages`
--

CREATE TABLE IF NOT EXISTS `y0hw2_messages` (
...
--
-- Table structure for table `y0hw2_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `y0hw2_messages_cfg` (
...
--
-- Table structure for table `y0hw2_modules`
--

CREATE TABLE IF NOT EXISTS `y0hw2_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `y0hw2_modules`
--

INSERT INTO `y0hw2_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Main Menu', '', '', 1, 'menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"nav navbar-nav","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
(87, 55, 'head left', '', '<p><a>Content Marketing Institute</a></p>', 1, 'head-left', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":" pull-left","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(88, 56, 'head right', '', '<p><a>About Us</a> <a>Email</a> <a>Updates</a> <a>Contact Us </a></p>', 1, 'head-right', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":" pull-right","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(89, 57, 'logo', '', '<p><img class="img-responsive" src="images/logo.png" alt="" /></p>', 1, 'logo', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(90, 58, 'header right', '', '<p><img class="img-responsive" src="images/b.png" alt="" /></p>', 0, 'header-right', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(91, 60, 'content-1', '', '<header>\r\n<h3><span class="font-bold">Join Over 150,000</span> of your Peers!</h3>\r\n<p>Get daily articles and news delivered to your email inbox and get CMI’s exclusive e-book <span class="font-italic">Launch Your Own Content Marketing Program</span> FREE!</p>\r\n<p> </p>\r\n</header><form id="subscribe" action="" method="post"><input id="subbox" name="E-mail Address" type="text" value="Enter your email address..." /> <input id="subbutton" type="submit" value="Send Me Updates" /></form>', 1, 'contain-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(92, 61, 'content-2', '', '<p><img class="img-responsive" src="images/box.png" alt="" /></p>', 0, 'contain-2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(93, 62, 'content-3', '', '<div class="widget-wrap"><!-- SocialBox Widget --> <!-- SocialBox Widget -->\r\n<div id="socialbox" class="socialbox-widget socialbox-style-plainlarge box_ima" style="padding: 0 10px;">\r\n<h3><b>Connect With Us</b></h3>\r\n<ul>\r\n<li id="soc-13" class="first-child">\r\n<div class="socall">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/1.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">153,091</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">Subscribers</span></div>\r\n<a class="socialbox-button slideshare">Subscribe</a></div>\r\n</li>\r\n<li id="soc-2">\r\n<div class="socall default">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/2.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">106,378</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">Fans</span></div>\r\n<a class="socialbox-button facebook"> Like </a></div>\r\n</li>\r\n<li id="soc-3">\r\n<div class="socall">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/3.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">178,489</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">Followers</span></div>\r\n<a class="socialbox-button twitter"> Follow </a></div>\r\n</li>\r\n<li id="soc-21">\r\n<div class="socall">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/4.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">25,862</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">Followers</span></div>\r\n<a class="socialbox-button linkedin">Follow</a></div>\r\n</li>\r\n<li>\r\n<div class="socall">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/5.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">12,366</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">IN CIRCLES</span></div>\r\n<a class="socialbox-button gplus">Circle</a></div>\r\n</li>\r\n<li id="soc-6">\r\n<div class="socall">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/6.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">7,563</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">Subscribers</span></div>\r\n<a class="socialbox-button youtube">Subscribe</a></div>\r\n</li>\r\n<li class="last-child">\r\n<div class="socall" style="color: #8c8c8c;">\r\n<div class="socim"><a class="socim" target="_blank"><img src="images/7.png" alt="" /></a></div>\r\n<div class="socnums"><span style="color: #161616; position: relative; bottom: 2px;">6,080</span></div>\r\n<div class="soctyp"><span style="position: relative; top: 4px; color: #8c8c8c;">Followers</span></div>\r\n<a class="socialbox-button slideshare">Follow</a></div>\r\n</li>\r\n</ul>\r\n</div>\r\n<!-- End SocialBox Widget --></div>', 1, 'contain-3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(94, 63, 'footer-menu', '', '<h4>Company</h4>\r\n<div class="linewite" style="color: #fff !important;"> </div>\r\n<ul class="margintop10">\r\n<li><a>About us</a></li>\r\n<li><a>Contact us </a></li>\r\n<li><a>Privacy policy</a></li>\r\n<li><a>Sitemap</a></li>\r\n</ul>', 1, 'footer-menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(95, 64, 'footer-1', '', '<p><img src="images/logo.png" alt="" /></p>\r\n<p> </p>\r\n<div id="lipsum">\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam consectetur ligula vitae eleifend egestas. Etiam varius gravida justo. Vestibulum semper id ligula eget luctus. Vivamus ornare dictum sollicitudin.</p>\r\n</div>\r\n<p> </p>', 0, 'footer-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(96, 65, 'footer-3', '', '<h4>Social Icon</h4>\r\n<div class="linewite" style="color: #fff !important;"> </div>\r\n<ul class="margintop10">\r\n<li><a> Facebook </a></li>\r\n<li><a> Twitter</a></li>\r\n<li><a> Linkedin</a></li>\r\n<li><a> Google+</a></li>\r\n</ul>', 1, 'footer-3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(97, 66, 'footer-4', '', '<h4>Company Info</h4>\r\n<div class="linewite" style="color: #fff !important;"> </div>\r\n<div class="map">\r\n<p> </p>\r\n<ul class="list-unstyled contact-address">\r\n<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam consectetur ligula<br /> <a> +91 9876543211 </a></li>\r\n</ul>\r\n<p> </p>\r\n</div>', 1, 'footer-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(98, 67, 'copyright', '', '<p class="margin0" data-wow-duration="3s">Copyright 2015. All Rights Reserved</p>', 0, 'copyright', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_modules_menu`
--

CREATE TABLE IF NOT EXISTS `y0hw2_modules_menu` (
...
--
-- Dumping data for table `y0hw2_modules_menu`
--

INSERT INTO `y0hw2_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `y0hw2_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `y0hw2_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `y0hw2_overrider`
--

CREATE TABLE IF NOT EXISTS `y0hw2_overrider` (
...
--
-- Table structure for table `y0hw2_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `y0hw2_postinstall_messages` (
...
--
-- Dumping data for table `y0hw2_postinstall_messages`
--

INSERT INTO `y0hw2_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `y0hw2_redirect_links`
--

CREATE TABLE IF NOT EXISTS `y0hw2_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `y0hw2_schemas`
--

CREATE TABLE IF NOT EXISTS `y0hw2_schemas` (
...
--
-- Dumping data for table `y0hw2_schemas`
--

INSERT INTO `y0hw2_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.5.1-2016-03-29');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_session`
--

CREATE TABLE IF NOT EXISTS `y0hw2_session` (
...
--
-- Dumping data for table `y0hw2_session`
--

INSERT INTO `y0hw2_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('629ce8f3462bb0f12dfbcbee095fdfb5', 0, 1, '1462804491', 'joomla|s:1604:"";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_tags`
--

CREATE TABLE IF NOT EXISTS `y0hw2_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `y0hw2_tags`
--

INSERT INTO `y0hw2_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `y0hw2_template_styles`
--

CREATE TABLE IF NOT EXISTS `y0hw2_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `y0hw2_template_styles`
--

INSERT INTO `y0hw2_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '1', 'protostar - Default', '{"templateColor":"#0088cc","templateBackgroundColor":"#f4f6f7","logoFile":"images\\/logo.png","sitetitle":"","sitedescription":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_ucm_base`
--

CREATE TABLE IF NOT EXISTS `y0hw2_ucm_base` (
...
--
-- Table structure for table `y0hw2_ucm_content`
--

CREATE TABLE IF NOT EXISTS `y0hw2_ucm_content` (
...
--
-- Table structure for table `y0hw2_ucm_history`
--

CREATE TABLE IF NOT EXISTS `y0hw2_ucm_history` (
...
--
-- Dumping data for table `y0hw2_ucm_history`
--

INSERT INTO `y0hw2_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 1, 1, '', '2016-05-05 13:21:20', 234, 5181, '6bf039e891880e141452de7a5040b35f0415f757', '{"id":1,"asset_id":54,"title":"demo","alias":"demo","introtext":"<div id=\\"lipsum\\">\\r\\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integ
. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Pellentesque commodo, augue eu ultricies malesuada, nulla sapien posuere urna, quis vestibulum mi arcu vel nibh. Maecenas lacus nisl, tempus a iaculis vitae, hendrerit quis nibh. Donec a porttitor ante.<\\/p>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-05 13:21:20","created_by":"234","created_by_alias":"","modified":"2016-05-05 13:21:20","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2016-05-05 13:21:20","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(2, 2, 1, '', '2016-05-07 12:11:31', 234, 5481, 'a8bf5a2921673d1ef0fd1f20416333b32d024b5a', '{"id":2,"asset_id":59,"title":"home","alias":"home","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"img\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-07 12:11:31","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:11:31","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2016-05-07 12:11:31","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(3, 2, 1, '', '2016-05-07 12:34:00', 234, 5520, '896490974fc97986fc5c1f64f974d29867c960ee', '{"id":2,"asset_id":"59","title":"home","alias":"home","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"img\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-07 12:11:31","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:34:00","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-07 12:32:52","publish_up":"2016-05-07 12:11:31","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"0\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"0\\",\\"link_category\\":\\"0\\",\\"show_parent_category\\":\\"0\\",\\"link_parent_category\\":\\"0\\",\\"show_author\\":\\"0\\",\\"link_author\\":\\"0\\",\\"show_create_date\\":\\"0\\",\\"show_modify_date\\":\\"0\\",\\"show_publish_date\\":\\"0\\",\\"show_item_navigation\\":\\"0\\",\\"show_icons\\":\\"0\\",\\"show_print_icon\\":\\"0\\",\\"show_email_icon\\":\\"0\\",\\"show_vote\\":\\"0\\",\\"show_hits\\":\\"0\\",\\"show_noauth\\":\\"0\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"1","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(4, 1, 1, '', '2016-05-07 12:35:26', 234, 5503, 'be764e2c8b14c0ef10fd22aab4ad7afc9be06967', '{"id":1,"asset_id":"54","title":"demo","alias":"demo","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"images\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-05 13:21:20","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:35:26","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-07 12:34:45","publish_up":"2016-05-05 13:21:20","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"2","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(5, 1, 1, '', '2016-05-07 12:36:17', 234, 5507, '39276a9488c8c57e2be92368f617ae2d41897a70', '{"id":1,"asset_id":"54","title":"demo","alias":"demo","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"images\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-05 13:21:20","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:36:17","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-07 12:35:26","publish_up":"2016-05-05 13:21:20","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"0\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"2","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(6, 2, 1, '', '2016-05-07 12:42:15', 234, 5524, '67ddba164893a1a26bdda7626a0322c6b2aff461', '{"id":2,"asset_id":"59","title":"home","alias":"home","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"images\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-07 12:11:31","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:42:15","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-07 12:41:47","publish_up":"2016-05-07 12:11:31","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"0\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"0\\",\\"link_category\\":\\"0\\",\\"show_parent_category\\":\\"0\\",\\"link_parent_category\\":\\"0\\",\\"show_author\\":\\"0\\",\\"link_author\\":\\"0\\",\\"show_create_date\\":\\"0\\",\\"show_modify_date\\":\\"0\\",\\"show_publish_date\\":\\"0\\",\\"show_item_navigation\\":\\"0\\",\\"show_icons\\":\\"0\\",\\"show_print_icon\\":\\"0\\",\\"show_email_icon\\":\\"0\\",\\"show_vote\\":\\"0\\",\\"show_hits\\":\\"0\\",\\"show_noauth\\":\\"0\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"49","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(7, 2, 1, '', '2016-05-07 12:42:31', 234, 5525, '2bb4b5b6e8be2e24819accebb4a65e32e8cda910', '{"id":2,"asset_id":"59","title":"home","alias":"home","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"images\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#0054A3\\">\\r\\n<th>\\u00a0<\\/th>\\r\\n<th>Women\\u2019s<\\/th>\\r\\n<th>Men\\u2019s<\\/th>\\r\\n<th>Children\\u2019s<\\/th>\\r\\n<\\/tr>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"#ADC5E7\\">\\r\\n<td colspan=\\"4\\">Tops<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Shirts\\/blouses<\\/td>\\r\\n<td>$2\\u201312<\\/td>\\r\\n<td>$2\\u20138<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<tr>\\r\\n<td>Sweaters<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$5\\u201315<\\/td>\\r\\n<td>$1\\u20136<\\/td>\\r\\n<\\/tr>\\r\\n<\\/tbody>\\r\\n<\\/table>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-07 12:11:31","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:42:31","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-07 12:42:15","publish_up":"2016-05-07 12:11:31","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"0\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"1\\",\\"show_category\\":\\"0\\",\\"link_category\\":\\"0\\",\\"show_parent_category\\":\\"0\\",\\"link_parent_category\\":\\"0\\",\\"show_author\\":\\"0\\",\\"link_author\\":\\"0\\",\\"show_create_date\\":\\"0\\",\\"show_modify_date\\":\\"0\\",\\"show_publish_date\\":\\"0\\",\\"show_item_navigation\\":\\"0\\",\\"show_icons\\":\\"0\\",\\"show_print_icon\\":\\"0\\",\\"show_email_icon\\":\\"0\\",\\"show_vote\\":\\"0\\",\\"show_hits\\":\\"0\\",\\"show_noauth\\":\\"0\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":4,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"50","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(8, 1, 1, '', '2016-05-07 12:43:29', 234, 2291, 'eafc3b6b6f572d6d6f7d0e2d48e9cbe96507a246', '{"id":1,"asset_id":"54","title":"demo","alias":"demo","introtext":"<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>","fulltext":"","state":1,"catid":"2","created":"2016-05-05 13:21:20","created_by":"234","created_by_alias":"","modified":"2016-05-07 12:43:29","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-07 12:43:01","publish_up":"2016-05-05 13:21:20","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"0\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":4,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"5","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);
INSERT INTO `y0hw2_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(9, 2, 1, '', '2016-05-07 12:44:34', 234, 5533, 'dd9cae8d748923958c50df68cafd4ece63230765', '{"id":2,"asset_id":"59","title":"Articles","alias":"articles","introtext":"<div class=\\"col-md-9 col-sm-9\\">\\r\\n<h3>Valuation Guide for Goodwill Donors<\\/h3>\\r\\n<div class=\\"row\\">\\r\\n<div class=\\"col-md-4 col-sm-4\\"><img class=\\"img-responsive\\" src=\\"images\\/pic.png\\" alt=\\"\\" \\/><\\/div>\\r\\n<div class=\\"col-md-8 col-sm-8\\">\\r\\n<p>The U.S. Internal Revenue Service (IRS) requires donors to value their items. To help guide you, Goodwill Industries International has compiled a list providing price ranges for items commonly sold in Goodwill \\u00ae stores. Assume the following items are in good condition, and remember: prices are only estimated values.<\\/p>\\r\\n<p>Young was hauling the container not just here, but everywhere \\u2013 around his office, on his daily commute in New York, through the streets of Cleveland during CMWorld 2014. And he would continue to lug it until he raised $31,000 for charity: water in honor of his own 31st birthday. His is one among tens of thousands of birthday pledges and other fundraising stunts run by ordinary people and celebrities alike in support of charity: water\\u2019s mission.<\\/p>\\r\\n<p>Hand in hand with its fundamental cause, charity: water also intends to reinvent charity \\u2013 from the way it engages the public to the way it distributes and tracks every dollar raised. Young elaborates, \\u201cWe think about brand in ways very few nonprofits do. There are brands of toothpaste peddled with more sophistication than all of the world\\u2019s most pressing causes. We want people to love our brand. But we don\\u2019t have a traditional marketing budget \\u2013 we don\\u2019t do direct mail. We invest heavily in content and spread that through word-of-mouth marketing and great partnerships.\\u201d<\\/p>\\r\\n<\\/div>\\r\\n<div class=\\"col-md-12 fullwidth\\">\\r\\n<div class=\\"table-responsive\\">\\r\\n<table class=\\"table\\">\\r\\n<tbody>\\r\\n<tr style=\\"color: #fff;\\" bgcolor=\\"
convallis ipsum eu tortor fermentum, vitae cursus orci placerat. In purus ex, blandit eu efficitur consequat, iaculis at mi. Phasellus tristique blandit laoreet. Maecenas porta tellus ac leo rhoncus, non mollis nunc ornare. Quisque ultricies bibendum tortor. Nam posuere nunc a mi pellentesque, sit amet scelerisque magna dictum. Fusce a dapibus ante. Maecenas faucibus, est id vehicula tempus, mi odio suscipit ipsum, quis vehicula est ligula ut nulla. Praesent sit amet turpis viverra, euismod enim nec, efficitur massa.<\\/p>\\r\\n<\\/div>","fulltext":"","state":1,"catid":"2","created":"2016-05-05 13:21:20","created_by":"234","created_by_alias":"","modified":"2016-05-09 10:24:27","modified_by":"234","checked_out":"234","checked_out_time":"2016-05-09 10:23:57","publish_up":"2016-05-05 13:21:20","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"0\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":6,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"17","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_updates`
--

CREATE TABLE IF NOT EXISTS `y0hw2_updates` (
...
--
-- Table structure for table `y0hw2_update_sites`
--

CREATE TABLE IF NOT EXISTS `y0hw2_update_sites` (
...
--
-- Dumping data for table `y0hw2_update_sites`
--

INSERT INTO `y0hw2_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1462796275, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1462796275, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 0, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1462796204, '');

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `y0hw2_update_sites_extensions` (
...
--
-- Dumping data for table `y0hw2_update_sites_extensions`
--

INSERT INTO `y0hw2_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `y0hw2_usergroups`
--

CREATE TABLE IF NOT EXISTS `y0hw2_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `y0hw2_usergroups`
--

INSERT INTO `y0hw2_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `y0hw2_users`
--

CREATE TABLE IF NOT EXISTS `y0hw2_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `email` (`email`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=235 ;

--
-- Dumping data for table `y0hw2_users`
--

INSERT INTO `y0hw2_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(234, 'Super User', 'admin', 'kamapatidar.incarnate@gmail.com', '$2y$10$TnQLm/7RvGTH.4ZEmehm8OXOkmtVwrgfs.1T4HPevt.0XLvvtrWLW', 0, 1, '2016-05-05 07:58:36', '2016-05-09 12:14:56', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_user_keys`
--

CREATE TABLE IF NOT EXISTS `y0hw2_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `y0hw2_user_notes`
--

CREATE TABLE IF NOT EXISTS `y0hw2_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `y0hw2_user_profiles`
--

CREATE TABLE IF NOT EXISTS `y0hw2_user_profiles` (
...
--
-- Table structure for table `y0hw2_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `y0hw2_user_usergroup_map` (
...
--
-- Dumping data for table `y0hw2_user_usergroup_map`
--

INSERT INTO `y0hw2_user_usergroup_map` (`user_id`, `group_id`) VALUES
(234, 8);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `y0hw2_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `y0hw2_utf8_conversion`
--

INSERT INTO `y0hw2_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `y0hw2_viewlevels`
--

CREATE TABLE IF NOT EXISTS `y0hw2_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `y0hw2_viewlevels`
--

INSERT INTO `y0hw2_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
